...
require_relative '../../app/controllers/tenderstoragecontroller'
...
describe TenderStorageController, type: 'model' do
  ...
  # end
  # let(:tender) do
  #   Tender.new(ShipmentTenderDatum.new('Export', 'Wood tender',
  #                                     Route.new('A', 'B')),
  #              ProposalsDatum.new(Date.today + 1))
  # end
  # let(:updated_tender) do
  #   Tender.new(ShipmentTenderDatum.new('Import', 'Wood tender',
  #                                     Route.new('A', 'B')),
  #              ProposalsDatum.new(Date.today + 1))
  # end
